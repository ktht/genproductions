...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'ResonanceDecayFilter:udscbAsEquivalent = on', # ignore quark flavor in final state
            'ResonanceDecayFilter:daughters = 1,1,1,1,1,1', # W bosons must produce at least 6 quarks
          ),
