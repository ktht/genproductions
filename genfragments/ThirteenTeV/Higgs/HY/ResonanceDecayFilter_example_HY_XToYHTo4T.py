...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '25:oneChannel = 1 1 100 15 -15', # H->tau+ tau- only possible
            '25:onIfMatch = 15 -15', # enable H->tau+ tau-
            '35:onMode = off', # disable all Y decay modes
            '35:oneChannel = 1 1 100 15 -15', # Y->tau+ tau- only possible
            '35:onIfMatch = 15 -15', # enable Y->tau+ tau-
          ),
